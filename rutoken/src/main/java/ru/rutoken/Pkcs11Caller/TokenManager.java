...
public class TokenManager {
    public static Token tokenShared = null;
    ...
    private class TokenInfoLoader extends Thread {
        ...
        Set<NativeLong> ar =  token.enumerateCertificates();
            for (NativeLong nl:ar){

               Certificate cert = token.getCertificate(nl);
            ...
            try {
                TokenManager.tokenShared.logout(new Pkcs11Callback() {
                    @Override
                ...
                TokenManager.tokenShared.close();
...
//        }
    ...
    public synchronized void init(Context context) {
     ...
     //   mEventHandler = new EventHandler(); //lda
     //   mEventHandler.start();        //lda
    }
